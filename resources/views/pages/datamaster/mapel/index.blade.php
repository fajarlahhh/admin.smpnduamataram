            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="/mapel/tambah" class="btn btn-sm btn-primary">Tambah</a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ ++$i }}</td>
                                        <td class="text-nowrap">{{ $row->mapel_nama }}</td>
                                        <td class="text-right" nowrap>
                                            <div class="btn-group">
                                            </div>
                                            <div class="btn-group">
                                                <a href="{{ route('mapel.edit', array('id' => $row->mapel_id)) }}" class="btn btn-info"> Edit</a>
                                                <a href="javascript:;" data-id="{{ $row->mapel_id }}" data-no="{{ $i }}" class="btn-danger btn btn-hapus" > Hapus</a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
