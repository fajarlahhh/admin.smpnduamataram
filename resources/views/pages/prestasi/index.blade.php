            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="/prestasi/tambah" class="btn btn-sm btn-primary">Tambah</a>
                        <div class="card-tools">
                            <form action="/prestasi" method="GET">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" nowrap>
                                            <div class="btn-group">
                                                <a href="javascript:;" data-id="{{ $row->prestasi_id }}" data-no="{{ $i }}" class="btn-danger btn btn-hapus" > Hapus</a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
