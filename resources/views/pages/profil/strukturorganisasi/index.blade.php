                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ ++$i }}</td>
                                        <td>{{ $row->struktur_organisasi_jabatan }}</td>
                                        <td>{{ $row->struktur_organisasi_pejabat }}</td>
                                        <td>{{ $row->struktur_organisasi_pejabat_nip }}</td>
                                        <td><a href="{{ $row->struktur_organisasi_foto }}" target="_blank">Gambar</a></td>
                                        <td class="text-right" nowrap>
                                            <div class="btn-group">
                                            </div>
                                            <div class="btn-group">
                                                <a href="{{ route('strukturorganisasi.edit', array('id' => $row->struktur_organisasi_id)) }}" class="btn btn-info"> Edit</a>
                                                <a href="javascript:;" data-id="{{ $row->struktur_organisasi_id }}" data-no="{{ $i }}" class="btn-danger btn btn-hapus" > Hapus</a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
