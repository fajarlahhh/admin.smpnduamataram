            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="/kegiatan/tambah" class="btn btn-sm btn-primary">Tambah</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" nowrap>
                                            ...
                                            <div class="btn-group">
                                                <a href="{{ route('kegiatan.edit', array('id' => $row->kegiatan_id)) }}" class="btn btn-info"> Edit</a>
                                                <a href="javascript:;" data-id="{{ $row->kegiatan_id }}" data-no="{{ $i }}" class="btn-danger btn btn-hapus" > Hapus</a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
