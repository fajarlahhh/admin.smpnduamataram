            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="/carousel/tambah" class="btn btn-sm btn-primary">Tambah</a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ ++$i }}</td>
                                        <td>{{ $row->carousel_judul }}</td>
                                        <td>{{ $row->carousel_uraian }}</td>
                                        <td><a href="{{ $row->carousel_gambar }}" target="_blank">Gambar</a></td>
                                        <td class="text-right" nowrap>
                                            <div class="btn-group">
                                            </div>
                                            <div class="btn-group">
                                                <a href="javascript:;" data-id="{{ $row->carousel_id }}" data-no="{{ $i }}" class="btn-danger btn btn-hapus" > Hapus</a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
