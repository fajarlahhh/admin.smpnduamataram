            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="/pengguna/tambah" class="btn btn-sm btn-primary">Tambah</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" nowrap>
                                            ...
                                            <div class="btn-group">
                                                <a href="{{ route('pengguna.edit', array('id' => $row->pengguna_id)) }}" class="btn btn-info"> Edit</a>
                                                <a href="javascript:;" data-id="{{ $row->pengguna_id }}" data-no="{{ $i }}" class="btn-danger btn btn-hapus" > Hapus</a>
                                            </div>
                                            @endif
                                        </td>
                                    </tr>
