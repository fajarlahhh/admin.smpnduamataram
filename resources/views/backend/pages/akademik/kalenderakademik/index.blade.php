            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="/admin-area/kalenderakademik/tambah" class="btn btn-sm btn-primary">Tambah</a>
                        <div class="card-tools">
                            <form action="/admin-area/kalenderakademik" method="GET">
...
<script>
    $(".btn-hapus").on('click', function () {
        ...
        if (r == true) {
            ...
            $.ajax({
                url: "/admin-area/kalenderakademik/hapus",
                type: "POST",
                data: {
                    "_method": 'DELETE',
                    "id" : id
